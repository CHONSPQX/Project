<!doctype html>
<html id="page-home" class="page-home big_command [: _base.device :]" ng-cloak
      ng-app="page"
      ng-controller="CBase">
<head>
    <meta charset="UTF-8">
...
<div ng-if="_base.d.pop.show" ng-class="{
    ...
    [: _base.d.pop.msg :]
</div>    <script src="/dist/regular.bundle.min.js?v=62"></script>
            <script src="/dist/regular.bundle.home.min.js?v=62"></script>
        <script>
  var _hmt = _hmt || [];
  (function () {
