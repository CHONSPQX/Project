...
<%
  ArrayList<String> label=(ArrayList<String>)request.getAttribute("AllThirdClass");
					...
					<table class="table table-hover">
						...
						<tr>
							...
							<td><a class="button border-green button-little"
								href="Classifier!checkFilebyClass4?firstclass=<%=label1%>&secondclass=<%=label2%>&thirdclass=<%=temp%>">进入</a>
							</td>
						</tr>
						<%
						  }
