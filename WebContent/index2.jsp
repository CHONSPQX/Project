	...
	<div class="top-nav">
		...
		<div class="soc_right">
	          	...
	          	<div class="web_search">
				 	<form action="SearchAction!SearchFile">
				 		<select name="searchTarget">
				 			<option value="0">我的文件</option>
				 			<option value="1">共享文件</option>
				 		</select>
				 		<input type="text" name="CheckedFile" value="Search.." onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search..';}">
						...
						<div id="tab1">
							<div class="latest-news-tab-grid frist-news-grid" onclick="location.href='#';">
								...
								<div class="latest-news-tab-grid-info">
									<p>In pharetra pretium convallis. Mauris sollicitudin ligula non mi hendrerit varius.,</p>
								</div>
								<div class="clear"> </div>
							</div>
							<div class="latest-news-tab-grid frist-news-grid" onclick="location.href='#';">
								...
								<div class="latest-news-tab-grid-info">
									<p>Mauris sollicitudin In pharetra pretium convallis.  ligula non mi hendrerit varius.,</p>
								</div>
								<div class="clear"> </div>
							</div>
							<div class="latest-news-tab-grid second-news-grid" onclick="location.href='#';">
								...
								<div class="latest-news-tab-grid-info">
									<p> convallis. In pharetra pretium Mauris sollicitudin ligula non mi hendrerit varius.,</p>
								</div>
								<div class="clear"> </div>
							</div>
							<div class="latest-news-tab-grid frist-news-grid" onclick="location.href='#';">
								...
								<div class="latest-news-tab-grid-info">
									<p>mi hendrerit varius., In pharetra pretium convallis. Mauris sollicitudin ligula non </p>
								</div>
								<div class="clear"> </div>
							</div>
						</div>
		...
		<div class="r-tags-social-icons">
			...
			<div class="big-social-icons">
				<ul>
					<li><a class="big-facebook" href="#"> <span>36,507 Fans</span></a></li>
					<li><a class="big-twitter" href="#"> <span>9,136 Followers</span></a></li>
					<li><a class="big-gplus" href="#"> <span>15,047 Fans</span></a></li>
				</ul>
			</div>
			<div class="clear"> </div>
		</div>
