	...
	<div class="line">
		<div class="x4">
			<select name="searchTarget">
				<option value="0">我的文章</option>
				<option value="1">共享文章</option>
			</select>
		</div>
		<div class="x8">
		<div class="x6"><input type="text" class="input" name="keywords" size="30" placeholder="关键词" /></div>
    	<div class="x2"><button type="button" class="button"><span class="glyphicon glyphicon-search">搜!</span></button></div>		
    	</div>
    </div>
    </div>
    </form>
